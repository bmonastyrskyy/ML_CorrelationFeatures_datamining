...
public class GroupCanvasSubGroups extends JPanel {
	...
	*/
	...
	public GroupCanvasSubGroups(Group group, SubgroupsPerPosition sgpp, int subGroupIndex) {
		this.group = group;
		this.sgpp = sgpp;
